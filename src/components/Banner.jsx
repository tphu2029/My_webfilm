...
const Banner = () => {
  return (
    <div className="w-full h-[600px] bg-banner bg-center bg-no-repeat bg-cover relative">
      ...
      <div
        className="w-full h-full flex items-center justify-center space-x-[30px] p-4
      relative z-20"
      >
        <div className="flex flex-col space-y-5 items-baseline w-[50%]">
          <p className="text-white ml-4 bg-gradient-to-r from-red-600  to-red-300 text-md py-3 px-6 border-radius-3">
            TV Show
          </p>
          <div className="flex flex-col space-y-4">
            ...
            <p className="text-white text-sm flex flex-col">
              ...
              porro quam deserunt, dolorum itaque aspernatur, velit doloremque
              atque ratione culpa nesciunt excepturi, sunt assumenda id? Nulla
              minima provident vero ex?
            </p>
        ...
        <div className="w-[50%] flex items-center justify-center">
          <div className="w-[300px] h-[400px] relative cursor-pointer group">
            <img
              src={ImgTemp}
              alt="temp"
